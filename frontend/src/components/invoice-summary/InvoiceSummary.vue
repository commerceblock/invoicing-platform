<template>
  <div class="invoice-wrapper">
    ...
    <form-wizard title="" subtitle="" class="invoice" color="#538C46">
      <tab-content title="Download Invoice" icon="fa fa-cloud-download">
      ...
      <tab-content title="Sign Invoice" icon="fa fa-file-text-o" :before-change="processContract">
        <div class="invoice-box">
          <invoice-header :invoiceId="invoiceId" :date="date"></invoice-header>
    ...
    <div>
      <div class="footer">This invoice has been generated using the CommerceBlock platform<br>Please do not share this link with anyone</div>
